                ...
                <div class="card-body table-card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card my-2">
                                        <div class="card-header d-flex justify-content-between">
                                            <div class="table-head">
                                                <i class="fas fa-edit"></i> Board of Directors  Entry
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <label for="title" class="col-sm-3 col-form-label">Message<span
                                                style="color:red">*</span></label>
                                        <div class="col-sm-9 mb-2">
                                            <textarea name="message" rows="3" placeholder=" Board Of Directors Message"
                                                class="form-control form-control-sm shadow-none ckeditor">{{ old('message') }}</textarea>
                                            @error('message')
                                            <span style="color: red">{{ $message }}</span>
                                            @enderror
                                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card my-2">
                                <div class="card-header d-flex justify-content-between">
                                    <div class="table-head"><i class="fas fa-table me-1"></i> Our Board Of Directors  List
                                    </div>
                                        ...
                                        <table class="table table-bordered text-center" id="datatablesSimple"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('directors.edit', $item->id) }}"
