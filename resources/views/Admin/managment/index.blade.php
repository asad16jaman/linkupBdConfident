        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-body table-card-body">
                    <div class="row">
                        <form method="post" action="{{ route('managment.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card my-2">
                                        <div class="card-header d-flex justify-content-between">
                                            <div class="table-head">
                                                <i class="fas fa-edit"></i>Our Managment Team
                                            </div>
                                        </div>
                                    </div>
