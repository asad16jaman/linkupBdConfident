    ...
    <div class="container-fluid" id="Category">
        <div class="heading-title p-2 my-2">
            <span class="my-3 heading "><i class="fas fa-home"></i> <a class="" href="{{ route('dashboard') }}">Home</a>
                > Our Managment Team Update</span>
        </div>
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-body table-card-body">
                    <div class="row">
                        <form method="post" action="{{ route('managment.update',$managment->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card my-2">
                                        <div class="card-header d-flex justify-content-between">
                                            <div class="table-head">
                                                <i class="fas fa-edit"></i>Our Managment Team Update
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="name" placeholder="Enter Full Name"
                                                value="{{ $managment->name}}"
                                                class="form-control form-control-sm shadow-none">
                                            @error('name')
                                            <span style="color: red">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <label for="title" class="col-sm-3 col-form-label">Designation<span
                                                style="color:red">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" name="designation" placeholder="Enter Designation"
                                                value="{{$managment->designation}}"
                                                class="form-control form-control-sm shadow-none">
                                            @error('designation')
                                            <span style="color: red">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <label for="title" class="col-sm-3 col-form-label">Department<span
                                                style="color:red">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" name="department" placeholder="Enter Department"
                                                value="{{ $managment->department }}"
                                                class="form-control form-control-sm shadow-none">
                                            @error('department')
                                            <span style="color: red">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="">
                                                <img src="{{ asset($managment->image) }}" id="mainThmb"
                        ...
                        <div class="col-lg-6">
                            <div class="card my-2">
                                <div class="card-header d-flex justify-content-between">
                                    <div class="table-head"><i class="fas fa-table me-1"></i> Our Managment Team List
                                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('managment.delete', $item->id) }}"
