                ...
                <div class="card-body table-card-body">
                    <div class="row">
                                    ...
                                    <div class="card my-2">
                                        <div class="card-header d-flex justify-content-between">
                                            <div class="table-head">
                                                <i class="fas fa-edit"></i> Our Story Update
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9 mb-2">
                                            <textarea name="description" rows="3" placeholder=" Description"
                                                class="form-control form-control-sm shadow-none ckeditor">{{$story->description}}</textarea>
                                            @error('description')
                                            <span style="color: red">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="">
                                                <img src="{{ asset($story->image) }}" id="mainThmb"
                        ...
                        <div class="col-lg-6">
                            <div class="card my-2">
                                <div class="card-header d-flex justify-content-between">
                                    <div class="table-head"><i class="fas fa-table me-1"></i> Our Story List
                                    </div>
                                        ...
                                        <table class="table table-bordered text-center" id="datatablesSimple"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('story.edit', $item->id) }}"
                                                            class="btn btn-edit"><i
                                                                class="fas fa-pencil-alt"></i></a>

                                                        <a href="{{ route('story.delete', $item->id) }}"
