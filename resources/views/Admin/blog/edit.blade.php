                                    ...
                                    <div class="card my-2">
                                        <div class="card-header d-flex justify-content-between">
                                            <div class="table-head">
                                                <i class="fas fa-edit"></i> Blogs Update
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <div class="mt-2">
                                                        <img src="{{ asset($blog->image) }}" id="mainThmb"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-2">
                                                ...
                                                <textarea name="description" rows="10" placeholder="Description"
                                                    class="form-control form-control-sm shadow-none ckeditor">{{ $blog->description }}</textarea>
                                                @error('description')
                                                <span style="color: red">{{ $message }}</span>
                                                @enderror
                                            </div>
