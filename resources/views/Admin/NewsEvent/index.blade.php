                                    ...
                                    <div class="card my-2">
                                        <div class="card-header d-flex justify-content-between">
                                            <div class="table-head">
                                                <i class="fas fa-edit"></i> News & Events Entry
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date" name="date" placeholder="Select Date" value="{{ old('date') }}"
                                                        class="form-control form-control-sm shadow-none">
                                                    @error('date')
                                                    <span style="color: red">{{ $message }}</span>
                                                    @enderror
